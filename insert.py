...
engine = create_engine('postgresql://postgres:defence@localhost/postgres')
db = scoped_session(sessionmaker(bind=engine))


def main():
    # db.execute(
    #     "INSERT INTO party (id, partyid, partyname) VALUES (1, 'PDP', 'PDP'),(2, 'DPP', 'DPP'), "
    #            "(3, 'ACN', 'ACN'), (4, 'PPA', 'PPA'), (5, 'CDC', 'CDC'),  (6, 'JP', 'JP'), (7, 'ANPP', 'ANPP'),"
    #            "(8, 'LABOUR', 'LABOUR'), (9, 'CPP', 'CPP');")
    #


    # polling unit
    # db.execute("INSERT INTO polling_unit (uniqueid, polling_unit_id, ward_id, lga_id, uniquewardid, "
    #            "polling_unit_number, polling_unit_name, polling_unit_description) VALUES (8, 6, 8, 17, 181, 'DT1708006', 'Sapele Ward 8 PU _', NULL), "
    #            "(9, 4, 1, 19, 194, 'DT1901004', 'Primary School in Aghara', 'Primary School in Aghara'), "
    #            "(10, 5, 1, 19, 194, 'DT1401005', 'Ishere Primary School  Aghara', 'Ishere Primary School Aghara'),"
    #            " (11, 5, 3, 34, 244, 'DT3403005', 'Igini Primary School', ' Esisi Road'),"
    #            "(12, 1, 4, 21, 220, 'DT2104001', 'Umukwapa poll unit 1', NULL),"
    #            "(13, 16, 1, 22, 223, 'DT2201016', 'Church in Effurun1 Ovie', 'Church in Effurun1 OvieL'),"
    #            "(14, 6, 1, 19, 194, 'DT1901006', 'Ishere Primary School Aghara', NULL), "
    #            "(15, 13, 1, 22, 224, 'DT2201013', 'Effurun 2 in Uvwie', 'Effurun 2 in Uvwie'),"
    #            "(16, 5, 7, 7, 59, 'DT0607005', 'school in ethiope west', 'school in ethiope west'),"
    #            "(17, 9, 1, 34, 242, 'DT3401009', 'agbasa 1', 'agbasa 1'),"
    #            "(18, 7, 1, 22, 223, 'DT2201007', 'Customary Court P.t.i Road', 'Customary Court P.t.i Road'),"
    #            "(19, 11, 2, 22, 224, 'DT2202011', 'effurun 2', 'effurun 2'),"
    #            "(20, 1, 9, 35, 262, 'DT3501001', 'asumbo town hall1', 'asumbo town hall1'),"
    #            "(21, 3, 2, 22, 224, 'DT2202003', 'eki-otoi', NULL),"
    #            "(22, 3, 7, 6, 59, 'DT0607003', 'pollling 3 in agbara', 'pollling 3 in agbara'),"
    #            "(23, 6, 8, 6, 60, 'DT0608006', 'aghara ii', 'aghara ii'),"
    #            "(24, 4, 8, 6, 60, 'Dt0608004', 'aghara ii', 'aghara ii'),"
    #            "(25, 6, 9, 35, 262, 'DT3509006', 'obiteogbon quarters', 'obiteogbon quarters'),"
    #            "(26, 7, 9, 35, 262, 'DT3509007', 'okegbe quarter1', 'okegbe quarter1'),"
    #            "(27, 2, 7, 6, 59, 'DT0607002', 'agbasa 1', 'agbasa 1'),"
    #            " (28, 13, 3, 34, 244, 'DT340313', 'gra', 'gra'),"
    #            " (29, 14, 7, 6, 59, 'DT0607014', 'agbasa 1', 'agbasa 1'),"
    #            "(30, 8, 4, 1, 19, 'DT0104008', 'anocha north', 'anocha north'),"
    #            "(31, 12, 3, 34, 244, 'DT340312', 'gra ward', 'gra ward'),"
    #            "(32, 12, 7, 6, 59, 'DT0607012', 'school in ethiope west', 'school in ethiope west'),"
    #            "(33, 4, 3, 9, 90, 'DT0903004', 'ellu ', 'ellu '),"
    #            "(34, 11, 9, 35, 262, 'DT3509011', 'emami quarter 2', 'emami quarter 2'), "
    #            "(35, 10, 9, 35, 262, 'DT3509010', 'emami quarter 1', 'emami quarter 1'),"
    #            "(36, 9, 9, 35, 262, 'DT3509009', 'oguanja quarters', 'oguanja quarters'),"
    #            "(37, 8, 9, 35, 262, 'DT3509008', 'okegbe quarters 2', 'okegbe quarters 2'),"
    #            "(38, 5, 9, 35, 262, 'DT3509005', 'obiteogbon quarters', 'obiteogbon quarters'),"
    #            " (39, 4, 9, 35, 262, 'DT3509004', 'ajudaibo primary school', 'ajudaibo primary school'),"
    #            "(40, 3, 9, 35, 262, 'DT3509003', 'ajudaibo primary school', 'ajudaibo primary school'),"
    #            "(41, 3, 4, 9, 91, 'DT0904003', 'isoko north', 'isoko north'),"
    #            " (42, 2, 9, 35, 262, 'DT3509002', 'hall 2', 'hall 2'),"
    #            " (43, 4, 7, 6, 59, 'DT0607004', 'school in ethiope west', 'school in ethiope west'),"
    #            "  (44, 16, 2, 22, 224, 'DT220216', 'uvwie', 'uvwie'),"
    #            "    (45, 6, 7, 6, 59, 'DT0607006', 'school in ethiope west', 'school in ethiope west'),"
    #            "(46, 14, 1, 19, 194, 'DT1901014', 'ughelli', 'ughelli'),"
    #            "    (47, 2, 10, 15, 156, 'DT1510002', 'cable point i', 'cable point i'),"
    #            "(48, 3, 10, 15, 156, 'DT1510003', 'cable point i', 'cable point i'),"
    #            "  (49, 4, 10, 15, 156, 'DT1510004', 'cable point i', 'cable point i'),"
    #            " (50, 5, 10, 15, 156, 'DT1510005', 'cable point i', 'cable point i'),"
    #            "    (51, 6, 10, 15, 156, 'DT1510006', 'cable point i', 'cable point i'),"
    #            "    (52, 7, 10, 15, 156, 'DT1510007', 'cable point i', 'cable point i'), "
    #            "(53, 8, 10, 15, 156, 'DT1510008', 'cable point i', 'cable point i'),"
    #            " (54, 9, 10, 15, 156, 'DT1510009', 'cable point i', 'cable point i'), "
    #            "(55, 10, 10, 15, 156, 'DT1510010', 'cable point i', 'cable point i'),"
    #            " (56, 11, 10, 15, 156, 'DT1510011', 'cable point i', 'cable point i'), "
    #            "(57, 15, 10, 15, 156, 'DT151015', 'cable point i', 'cable point i'), "
    #            "(58, 16, 10, 15, 156, 'DT151016', 'cable point i', 'cable point i'),"
    #            " (59, 17, 10, 15, 156, 'DT151017', 'cable point i', 'cable point i'),"
    #            "(60, 8, 8, 22, 222, 'DT2288', 'aka avenue', 'aka avenue'),"
    #            "(61, 8, 3, 17, 176, 'DT1738', 'sapele', 'sapele'),"
    #            "(62, 13, 7, 6, 59, 'DT6713', 'ethiope', 'ethiope'),"
    #            "(63, 5, 4, 1, 19, 'DT145', 'Aniocha North 4', 'Aniocha North 4'),"
    #            "(64, 13, 3, 2, 6, 'DT2313', 'aniocha ward 3', 'aniocha ward 3'),"
    #            "(65, 6, 4, 1, 19, 'DT146', 'aniocha ward 4', 'aniocha ward 4'),"
    #            " (66, 21, 1, 22, 223, 'DT22121', 'uru standard junction off jakpa rd', 'uru standard junction off jakpa rd'),"
    #            " (67, 1, 11, 15, 157, 'DT15111', 'Oshimili', 'Oshimili South'),"
    #            " (68, 2, 11, 10, 108, 'DT10112', 'Isoko', 'Isoko South'), (69, 3, 11, 15, 157, 'DT15113', 'Oshimili', 'Oshimili'),"
    #            " (70, 4, 11, 15, 157, 'DT15114', 'Oshimili', 'Oshimili South'),"
    #            "(71, 5, 11, 15, 157, 'DT15115', 'Oshimili', 'Oshimili South'),"
    #            " (72, 6, 11, 15, 157, 'DT15116', 'Oshimili', 'Oshimili South'),"
    #            "(73, 7, 11, 15, 157, 'DT15117', 'Oshimili', 'Oshimili South'),"
    #            "(74, 1, 5, 10, 104, 'DT105001', 'Isoko', 'Isoko South'),"
    #            "(75, 13, 10, 21, 218, 'DT211013', 'Ukwuani', 'Ukwuani '),"
    #            "(76, 3, 4, 21, 220, 'DT2143', 'Ukwuani', 'Ukwuani'), "
    #            "(77, 6, 1, 22, 223, 'DT2216', 'Effurun', 'Effurun'),"
    #            " (78, 11, 10, 21, 218, 'DT211011', 'Ukwuani', 'Ukwuani'),"
    #            "(79, 7, 4, 1, 19, 'DT147', 'aniocha', 'aniocha'),"
    #            "(80, 3, 0, 31, 28, 'DT3103', 'Bomadi', 'Bomadi'),"
    #            "(81, 5, 0, 31, 28, 'DT3105', 'Bomadi', 'Bomadi'),"
    #            " (82, 1, 0, 31, 28, 'DT310001', 'Bomadi', 'Bomadi'),"
    #            "(83, 3, 6, 13, 135, 'DT1363', 'Udogbie Village', 'Udogbie Village'),"
    #            "(84, 8, 12, 22, 226, 'DT22128', 'aka avenue', 'aka avenue'),"
    #            " (85, 3, 9, 6, 61, 'DT693', 'ethiope west ', 'ethiope west '),"
    #            "(86, 8, 8, 6, 60, 'DT688', 'ethiope', 'ethiope west '),"
    #            "(87, 2, 8, 6, 60, 'DT682', 'ethiope', 'ethiope west '),"
    #            " (88, 6, 10, 6, 62, 'DT6106', 'ethiope', 'ethiope west '),"
    #            "(89, 12, 9, 6, 61, 'DT6912', 'ethiope unit 12', 'ethiope unit 12'),"
    #            "(90, 7, 0, 31, 26, 'DT3107', 'kolafiogbene', 'kolafio'),"
    #            "(91, 11, 0, 31, 26, 'DT31011', 'kolafiogbene', 'kolafio'),"
    #            "(92, 15, 0, 31, 26, 'DT31015', 'kolafiogbene', 'kolafiogbene'),"
    #            "(93, 16, 0, 31, 26, 'DT31016', 'kolafiogbene', 'kolafiogbene'),"
    #            "(94, 9, 0, 31, 30, 'DT3109', 'kolafiogbene', 'kolafiogbene'),"
    #            " (95, 8, 0, 31, 30, 'DT3108', 'kolafiogbene', 'kolafiogbene'),"
    #            " (96, 14, 0, 31, 26, 'DT31014', 'kolafiogbene', 'kolafiogbene'),"
    #            " (97, 18, 0, 31, 26, 'DT31018', 'kolafiogbene', 'kolafiogbene'),"
    #            "  (98, 12, 0, 31, 26, 'DT31012', 'kolafiogbene', 'kolafiogbene'),"
    #            "(99, 4, 0, 31, 30, 'DT3104', 'kolafiogbene', 'kolafiogbene'),"
    #            "             (100, 6, 0, 31, 30, 'DT3106', 'kolafiogbene', 'kolafiogbene'),"
    #            "  (101, 10, 0, 31, 30, 'DT31010', 'kolafiogbene', 'kolafiogbene'),"
    #            "  (102, 51, 0, 31, 30, 'DT31051', 'kolafiogbene', 'kolafiogbene'),"
    #            "  (103, 21, 0, 31, 30, 'DT31021', 'kolafiogbene', 'kolafiogbene'),"
    #            "   (104, 31, 0, 31, 30, 'DT31031', 'kolafiogbene', 'kolafiogbene'),"
    #            "             (105, 5, 5, 11, 115, 'DT1155', 'Ndokwa east', 'Ndokwa east'),"
    #            "              (106, 13, 0, 34, 244, 'DT34013', 'gra', 'gra'),"
    #            "              (107, 12, 0, 34, 244, 'DT34012', 'gra', 'gra'),"
    #            "   (108, 1, 0, 32, 38, 'DT3201', 'seimbiri', 'seimbiri'),   "
    #            "(109, 6, 5, 11, 115, 'DT1156', 'ndokwa', 'ndokwa');"
    #            )
    ...
    #    """ INSERT
    # INTO
    # lga(uniqueid, lga_id, lga_name, state_id, lga_description)
    # VALUES
    #     (1, 1, 'Aniocha North', 25, 'Aniocha North'), \
    # (2, 2, 'Aniocha - South', 25, 'Aniocha - South'), \
    # (3, 5, 'Ethiope East', 25, 'Ethiope East'), \
    # (4, 6, 'Ethiope West', 25, 'Ethiope West'), \
    # (5, 7, 'Ika North - East', 25, 'Ika North - East'), \
    # (6, 8, 'Ika - South', 25, 'Ika - South'), \
    # (7, 9, 'Isoko North', 25, 'Isoko North'), \
    # (8, 10, 'Isoko South', 25, 'Isoko South'), \
    # (9, 11, 'Ndokwa East', 25, 'Ndokwa East'), \
    # (10, 12, 'Ndokwa West', 25, 'Ndokwa West'), \
    # (11, 13, 'Okpe', 25, 'Okpe'), \
    # (12, 14, 'Oshimili - North', 25, 'Oshimili - North'), \
    # (13, 15, 'Oshimili - South', 25, 'Oshimili - South'), \
    # (14, 16, 'Patani', 25, 'Patani'), \
    # (15, 17, 'Sapele', 25, 'Sapele'), \
    # (16, 18, 'Udu', 25, 'Udu'), \
    # (17, 19, 'Ughelli North', 25, 'Ughelli North'), \
    # (18, 20, 'Ughelli South', 25, 'Ughelli South'), \
    # (19, 21, 'Ukwuani', 25, 'Ukwuani'), \
    # (20, 22, 'Uvwie', 25, 'Uvwie'), \
    # (21, 31, 'Bomadi', 25, 'Bomadi'), \
    # (22, 32, 'Burutu', 25, 'Burutu'), \
    # (23, 33, 'Warri North', 25, 'Warri North'), \
    # (24, 34, 'Warri South', 25, 'Warri South'), \
    # (25, 35, 'Warri South West', 25, 'Warri South West');"""
    # )

#     db.execute("""INSERT INTO ward (uniqueid, ward_id, ward_name, lga_id, ward_description, entered_by_user, date_entered, user_ip_address) VALUES
...
# (263, 0, 'Ugborodo', 35, 'Ugborodo', 'Bincom', '0000-00-00 00:00:00', '127.0.0.1');""")
    ...
    #     """INSERT
    # INTO
    # announced_lga_results(result_id, lga_name, party_abbreviation, party_score, entered_by_user,
    ...
    # (8, '33', 'LABOUR', 1126, '', '2011-04-27 09:46:05', '192.168.1.110'), \
    ...
    # (26, '1', 'LABOUR', 63610, '', '2011-04-27 09:49:55', '192.168.1.110'), \
    ...
    # (35, '18', 'LABOUR', 77759, '', '2011-04-27 09:55:11', '192.168.1.110'), \
    ...
    # (44, '19', 'LABOUR', 75152, '', '2011-04-27 09:55:49', '192.168.1.110'), \
    ...
    # (53, '21', 'LABOUR', 90009, '', '2011-04-27 09:56:36', '192.168.1.110'), \
    ...
    # (62, '7', 'LABOUR', 23672, '', '2011-04-27 09:57:39', '192.168.1.110'), \
    ...
    # (71, '2', 'LABOUR', 82063, '', '2011-04-27 09:58:33', '192.168.1.110'), \
    ...
    # (80, '5', 'LABOUR', 84047, '', '2011-04-27 10:14:09', '192.168.1.110'), \
    ...
    # (89, '31', 'LABOUR', 10375, '', '2011-04-27 12:31:10', '192.168.1.101'), \
    ...
    # (107, '16', 'LABOUR', 29449, '', '2011-04-27 12:32:36', '192.168.1.101'), \
    ...
    # (116, '6', 'LABOUR', 64656, '', '2011-04-27 12:51:58', '192.168.1.101'), \
    ...
    # (125, '17', 'LABOUR', 52490, '', '2011-04-27 12:52:32', '192.168.1.101'), \
    ...
    # (134, '8', 'LABOUR', 52416, '', '2011-04-27 13:54:57', '192.168.1.101'), \
    ...
    # (143, '12', 'LABOUR', 92118, '', '2011-04-27 13:57:06', '192.168.1.101'), \
    ...
    # (152, '9', 'LABOUR', 42156, '', '2011-04-27 14:20:23', '192.168.1.101'), \
    ...
    # (161, '35', 'LABOUR', 2804, '', '2011-04-27 14:23:21', '192.168.1.101'), \
    ...
    # (170, '34', 'LABOUR', 7366, '', '2011-04-27 14:29:27', '192.168.1.101'), \
    ...
    # (179, '22', 'LABOUR', 84335, '', '2011-04-27 14:42:01', '192.168.1.101'), \
    ...
    # (188, '20', 'LABOUR', 64351, '', '2011-04-27 14:52:07', '192.168.1.101'), \
    ...
    # (197, '11', 'LABOUR', 57735, '', '2011-04-27 16:28:41', '192.168.1.101'), \
    ...
    # (206, '10', 'LABOUR', 44770, 'Omawuli - ', '2011-04-27 17:01:31', '192.168.1.101'), \
    ...
    # (215, '13', 'LABOUR', 26745, '', '2011-04-27 17:19:31', '192.168.1.101'), \
    ...
    # (224, '14', 'LABOUR', 38795, '', '2011-04-27 18:12:46', '192.168.1.101'), \
    ...
    # (233, '15', 'LABOUR', 85999, '', '2011-04-27 18:42:23', '192.168.1.101'), \
    ...
    # (242, '32', 'LABOUR', 64382, '', '2011-04-27 19:14:19', '192.168.1.101'), \
    ...
    db.execute(
        """INSERT
    INTO
    announced_pu_results(result_id, polling_unit_uniqueid, party_abbreviation, party_score, entered_by_user,
                           date_entered, user_ip_address)
    VALUES \
    ...
    (155, '10', 'LABOUR', 1012, 'Joseph Ogurume-christopher', '2011-04-26 17:26:20', '192.168.1.115'), \
    ...
    (163, '15', 'LABOUR', 139, '', '2011-04-26 17:27:54', '192.168.1.115'), \
    ...
    (171, '16', 'LABOUR', 596, 'bright oteri', '2011-04-26 18:04:38', '192.168.1.101'), \
    ...
    (179, '18', 'LABOUR', 627, 'Ruheme - Christopher', '2011-04-26 18:13:27', '192.168.1.115'), \
    ...
    (187, '19', 'LABOUR', 77, 'Enukpere Eric- christopher', '2011-04-26 18:22:57', '192.168.1.115'), \
    ...
    (196, '20', 'LABOUR', 426, 'Chris Tonne- christopher', '2011-04-26 18:25:24', '192.168.1.115'), \
    ...
    (205, '21', 'LABOUR', 805, 'ajeke jerry-christopher ', '2011-04-26 18:27:32', '192.168.1.115'), \
    ...
    (214, '24', 'LABOUR', 349, 'Tenison nana- christoper', '2011-04-26 18:33:01', '192.168.1.115'), \
    ...
    (223, '23', 'LABOUR', 943, 'Tenison nana- christoper', '2011-04-26 18:34:47', '192.168.1.115'), \
    ...
    (232, '22', 'LABOUR', 428, 'BRIGHT OTERI, OGUNMERU DARE', '2011-04-26 18:35:09', '192.168.1.114'), \
    ...
    (241, '25', 'LABOUR', 774, 'Chris Tonne- christopher', '2011-04-26 18:45:19', '192.168.1.115'), \
    ...
    (250, '26', 'LABOUR', 932, 'CHRIS TONWE, OGUNMERU DARE', '2011-04-26 18:46:01', '192.168.1.114'), \
    ...
    (259, '27', 'LABOUR', 492, 'BRIGHT OTERI, OGUNMERU DARE', '2011-04-26 18:47:53', '192.168.1.114'), \
